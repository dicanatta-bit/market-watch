...
.hdr-logo-left{{flex-shrink:0}}
.hdr-logo-left img{{height:50px;width:auto;display:block}}
...
.hdr-logo-right img{{height:40px;width:auto;display:block;background:#fff;padding:4px 8px;border-radius:6px}}
